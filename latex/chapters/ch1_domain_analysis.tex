...
To better understand \cite{agha2024socialmedia} the challenges students face and to validate the need for a
...
and communication habits.
    ...
    for a centralized platform that addresses these specific pain points. \cite{ijsem2023impact}
...
of both prospective and currently enrolled \cite{ejimed2023role} students by providing a centralized, 
